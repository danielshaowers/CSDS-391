...
public class AstarAgent extends Agent {
    ...
    public Map<Integer, Action> middleStep(State.StateView newstate, History.HistoryView statehistory) {
        ...
        //if the footman's next location
     ...
     * @param currentPath the planned path
     * @return true if the enemy footman is blocking the path
     */
    private boolean shouldReplanPath(State.StateView state, History.HistoryView history, Stack<MapLocation> currentPath)
    { //return whether there is an enemy footman at the same position as the next step in the path map
     ...
     *this requires us to add the last position into the stack first
     */
