...
public class GameState implements Comparable<GameState> {
    ...
    public GameState(Position agent, GameState state)
    {
    	...
    	this.currentGold = state.state.getResourceAmount(townHallId, ResourceType.GOLD);
    	this.currentWood = state.state.getResourceAmount(townHallId, ResourceType.WOOD);
    ...
    public List<GameState> generateChildren() {
    	...
    	for(int peasant : peasantIds) {
    		for(int i : goldmines) {
            	...
            	moveTo movingAgent = new moveTo(agent,location);
            	...
            	harvest harvestgold = new harvest(agent, location,peasant);
