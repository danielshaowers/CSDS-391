...
import edu.cwru.sepia.environment.model.state.Unit.UnitView;
	...
	private int turnNum;
	ArrayList<Stack<MapLocation>> optimalPath;
	
	public FutureUnit (int xLoc, int yLoc, int id, int hp, int turnNum, boolean good, ArrayList<Stack<MapLocation>> optimalPaths) {
		x = xLoc;
		y = yLoc;
		this.id = id;
		this.hp = hp;
